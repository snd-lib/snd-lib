...
import SOUND_KIT_01 from "./json/01.json";
import SOUND_KIT_02 from "./json/02.json";
import SOUND_KIT_03 from "./json/03.json";
...
const TOGGLE_SOUND_KEYS: string[] = [
	TOGGLE_ON,
	TOGGLE_OFF
];

const _SOUND_KEYS: SoundKeys = {
	BUTTON,
	CAUTION,
	CELEBRATION,
	DISABLED,
...
const _EVENT_CLASS_NAMES: { [key: string]: string; } = {
	[BUTTON]: `snd__${BUTTON}`,
...
export type KitKinds = "01" | "02" | "03";
const _KITS: { [key: string]: KitKinds; } = {
	SND01: "01",
	SND02: "02",
	SND03: "03",
};
...
export {
	KITS,
	KIT_INFO,
	TAG_EVENT_SOUND as ENABLE_TAGS,
	SOUNDS,
	EVENT_CLASS_NAMES,
	TAP_SOUND_KEYS,
	SWIPE_SOUND_KEYS,
